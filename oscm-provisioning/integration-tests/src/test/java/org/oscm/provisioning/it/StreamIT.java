...
import org.oscm.provisioning.api.GreetingMessage;
import org.oscm.provisioning.api.HelloService;
import org.oscm.provisioning.stream.api.StreamService;
...
public class StreamIT {
    ...
    public static void setup() {
        clientFactory = LagomClientFactory
            .create("integration-test", StreamIT.class.getClassLoader());
        ...
        streamService = clientFactory.createDevClient(StreamService.class,
            URI.create(SERVICE_LOCATOR_URI));
    ...
    public void helloWorld() throws Exception {
        ...
        await(
            helloService.useGreeting("bar").invoke(new GreetingMessage("Hi")));
    ...
    public void helloStream() throws Exception {
        ...
        List<String> messages = await(
            response.take(3).runWith(Sink.seq(), mat));
        assertEquals(Arrays.asList("Hello, a!", "Hello, b!", "Hello, c!"),
            messages);
    }
